--[[                                           Dev @TH3CZAR
    ____________________________________       Dev @TH3CZAR
   | |\    /| | |____   ____|   \ \  / /       Dev @TH3CZAR
   | | \  / | |      | |         \ \/ /        Dev @TH3CZAR
   | |\ \/ /| |      | |          \/\/         Dev @TH3CZAR
   | | \__/ | |      | |          /\/\         Dev @TH3CZAR
   | |      | |      | |         / /\ \        Dev @TH3CZAR
   |_|      |_|      |_|        /_/  \_\       Dev @TH3CZAR
              CH > @CHTH3CZAR
--]]
...
if not config2 then 
os.execute('cd .. &&  rm -rf MATREX')
os.execute('cd .. &&  rm -rf MATREXapi')
os.execute('cd .. &&  rm -fr MATREX')
os.execute('cd .. &&  rm -fr MATREXapi')
print(config2.tss)
 return false end
  -----------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, 1, '• `تم وضع الكليشه بالتحذير للعدد` ✓⬅️ : *'..sensspam[2]..'*', 1, 'md')
	...
	-----------------------------------------------------------------------------------------------
          local text = msg.content_.text_:gsub('تعميم','bc')
...
local user_msgs = database:get('user:msgs'..msg.chat_id_..':'..msg.sender_user_id_)
   ...
   if lockpt[2] == "bots" or TSHAKEPT[2] == "البوتات" then
	...
	local MATREX = {string.match(text, "^(قفل) (.*)$")} 
      if mutept[2] == "all" or MATREX[2] == "الكل" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "all warn" or MATREX[2] == "الكل بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "all ban" or MATREX[2] == "الكل بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "text" or MATREX[2] == "الدردشه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "text ban" or MATREX[2] == "الدردشه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "text warn" or MATREX[2] == "الدردشه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "inline" or MATREX[2] == "الانلاين" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "inline ban" or MATREX[2] == "الانلاين بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "inline warn" or MATREX[2] == "الانلاين بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "photo" or MATREX[2] == "الصور" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "photo ban" or MATREX[2] == "الصور بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "photo warn" or MATREX[2] == "الصور بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "video" or MATREX[2] == "الفيديو" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "video ban" or MATREX[2] == "الفيديو بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "video warn" or MATREX[2] == "الفيديو بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "gif" or MATREX[2] == "المتحركه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "gif ban" or MATREX[2] == "المتحركه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "gif warn" or MATREX[2] == "المتحركه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "music" or MATREX[2] == "الاغاني" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "music ban" or MATREX[2] == "الاغاني بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "music warn" or MATREX[2] == "الاغاني بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "voice" or MATREX[2] == "الصوت" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "voice ban" or MATREX[2] == "الصوت بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "voice warn" or MATREX[2] == "الصوت بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "links" or MATREX[2] == "الروابط" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "links ban" or MATREX[2] == "الروابط بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "links warn" or MATREX[2] == "الروابط بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "location" or MATREX[2] == "الشبكات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "location ban" or MATREX[2] == "الشبكات بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "location warn" or MATREX[2] == "الشبكات بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "tag" or MATREX[2] == "المعرف" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "tag ban" or MATREX[2] == "المعرف بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "tag warn" or MATREX[2] == "المعرف بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "hashtag" or MATREX[2] == "التاك" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "hashtag ban" or MATREX[2] == "التاك بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "hashtag warn" or MATREX[2] == "التاك بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "contact" or MATREX[2] == "الجهات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "contact ban" or MATREX[2] == "الجهات بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "contact warn" or MATREX[2] == "الجهات بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "webpage" or MATREX[2] == "المواقع" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "webpage ban" or MATREX[2] == "المواقع بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "webpage warn" or MATREX[2] == "المواقع بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "arabic" or MATREX[2] == "العربيه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "arabic ban" or MATREX[2] == "العربيه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "arabic warn" or MATREX[2] == "العربيه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "english" or MATREX[2] == "الانكليزيه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "english ban" or MATREX[2] == "الانكليزيه بالطرد" then
	  if not database:get('bot:text:ban'..msg.chat_id_) then
    if database:get('lang:gp:'..msg.chat_id_) then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "english warn" or MATREX[2] == "الانكليزيه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "spam del" or MATREX[2] == "الكلايش" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "spam warn" or MATREX[2] == "الكلايش بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "sticker" or MATREX[2] == "الملصقات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "sticker ban" or MATREX[2] == "الملصقات بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "sticker warn" or MATREX[2] == "الملصقات بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "file" or MATREX[2] == "الملفات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "file ban" or MATREX[2] == "الملفات بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "file warn" or MATREX[2] == "الملفات بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "markdown" or MATREX[2] == "الماركدون" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "markdown ban" or MATREX[2] == "الماركدون بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "markdown warn" or MATREX[2] == "الماركدون بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
	  ...
	  if mutept[2] == "service" or MATREX[2] == "الاشعارات" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "fwd" or MATREX[2] == "التوجيه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "fwd ban" or MATREX[2] == "التوجيه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "fwd warn" or MATREX[2] == "التوجيه بالتحذير" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "cmd" or MATREX[2] == "الشارحه" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "cmd ban" or MATREX[2] == "الشارحه بالطرد" then
    ...
    if database:get('lang:gp:'..msg.chat_id_) then
      ...
      if mutept[2] == "cmd warn" or MATREX[2] == "الشارحه بالتحذير" then
...
send(msg.chat_id_, msg.id_, 1, '• `الان يمكنك ارسال معرف المطور` 🗳', 1, 'md')
end
...
if text:match("^source$") or text:match("^اصدار$") or text:match("^الاصدار$") or text:match("^السورس$") or text:match("^سورس$") then
   ...
   local text =  [[
• <code>اهلا بك في سورس ماتريكس</code> 🦁ֆ
...
• https://github.com/moodlIMyIl/MATREX

• <code>رابط Github api </code>🔰:-
• https://github.com/TH3CZAR/MATREXapi
]]
                send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
   end
